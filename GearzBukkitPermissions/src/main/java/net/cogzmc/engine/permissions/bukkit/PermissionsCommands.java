...
package net.cogzmc.engine.permissions.bukkit;

import com.google.common.collect.Lists;
import net.cogzmc.engine.gearz.Gearz;
import net.cogzmc.engine.gearz.netcommand.NetCommand;
import net.cogzmc.engine.permissions.PermGroup;
import net.cogzmc.engine.permissions.PermPlayer;
import net.cogzmc.engine.util.command.*;
...
public class PermissionsCommands implements TCommandHandler, TTabCompleter {
    ...
    public TCommandStatus group(CommandSender sender, TCommandSender type, TCommand meta, Command command, String[] args) {
        ...
        switch (args[1]) {
            ...
            case "permissions":
                if (args.length != 2) return TCommandStatus.INVALID_ARGS;
                if (group == null) return TCommandStatus.INVALID_ARGS;
