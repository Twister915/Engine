...
package net.cogzmc.engine.gearz.player.bungee;
...
public final class GearzPlayer {
    ...
    /**
     * Deprecated in place of {@link GearzPlayer#GearzPlayer(net.md_5.bungee.api.connection.ProxiedPlayer)}
     *
    ...
    /**
     * Creates a {@link GearzPlayer} from a {@link net.md_5.bungee.api.connection.ProxiedPlayer}
     * This will store 100% correct {@link java.util.UUID}s and names
     *
     * @param player player to get the {@link GearzPlayer} for
