...
package net.cogzmc.engine.activerecord;
...
public abstract class GModel {
    ...
    static String getCollectionName(Class<? extends GModel> clazz) {
        String name;
        if (clazz.isAnnotationPresent(net.cogzmc.engine.activerecord.Collection.class)) {
            net.cogzmc.engine.activerecord.Collection annotation = clazz.getAnnotation(net.cogzmc.engine.activerecord.Collection.class);
