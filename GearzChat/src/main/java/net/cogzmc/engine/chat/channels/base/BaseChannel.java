...
package net.cogzmc.engine.chat.channels.base;
...
public interface BaseChannel {
     ...
     * @see net.cogzmc.engine.chat.channels.Channel#getFormat() for information of formatting
     */
    ...
    /**
     * Returns whether or not the channel is filtered by {@link net.cogzmc.engine.chat.filter.Filter}
     *
    ...
    /**
     * Sets whether or not the channel is filtered by {@link net.cogzmc.engine.chat.filter.Filter}
     *
     * @param filtered whether or not the channel is filtered by {@link net.cogzmc.engine.chat.filter.Filter}
     */
