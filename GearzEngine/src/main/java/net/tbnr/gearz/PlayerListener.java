...
public final class PlayerListener implements Listener {
	...
	public void onEntityBlockTest(final PlayerJoinEvent event) {
		new BukkitRunnable() {
			...
			public void run() {
				//Earth
				for(EntityBlock entityBlock : EntityBlockUtil.createSphere(16, event.getPlayer().getLocation().clone().add(0, 20, 0), Material.WOOL, DyeColor.LIGHT_BLUE.getWoolData(), 40, 40)) {
