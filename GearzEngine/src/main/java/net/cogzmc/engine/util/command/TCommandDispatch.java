...
public final class TCommandDispatch implements CommandExecutor, TabCompleter {
    ...
    /**
     * A {@link java.util.HashMap} that associates a {@link org.bukkit.command.Command} to it's {@link TTabCompleter}
     */
     ...
     * to the {@link TCommandHandler} parameter.
     *
     * @param handler the {@link TCommandHandler} to scan
    ...
    /**
     * Returns a {@link TTabCompleter} for the specified command
     *
     * @param command the command to search handlers for
     * @return the {@link TTabCompleter} that the command is registered to
     */
     ...
     * This method has been adapted to handle Gearz {@link TCommand} execution.
     *
    ...
    /**
     * Gets the {@link TCommandSender} associated with the {@link TCommandSender}.
     *
     * @param sender The actual {@link org.bukkit.command.CommandSender} object
     * @return The {@link TCommandSender} (enum value)
     */
